...
COMBINE_POLICY: dict[str, Policy] = {
    ...
    'GoogleWorkspace': Refuses(
        'one Google Workspace connection per id; two that differ need their own ids and PrefixTools',
        lambda cls: (cls('gmail', auth='first-key'), cls('gmail', auth='second-key')),
    ),
