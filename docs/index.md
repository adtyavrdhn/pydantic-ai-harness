...
| [GitHub](github.md) | Harness | Read and change one GitHub repository or organization through GitHub's hosted MCP server; writes wait for approval, `read_only=True` hides them |
