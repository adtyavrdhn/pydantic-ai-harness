...
| [Supabase](supabase.md) | Harness | Inspect and change one non-production Supabase project via its hosted MCP server; writes need approval, `read_only=True` drops the write tools |
