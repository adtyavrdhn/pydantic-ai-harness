...
[tool approval documentation](https://pydantic.dev/docs/ai/tools-toolsets/deferred-tools/). Approval prevents the model
from acting without confirmation. It does not replace authentication and server-side authorization for clients that
can submit message history.
