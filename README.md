...
| [Linear](pydantic_ai_harness/linear/) | Harness | Read and update Linear issues, projects, and teams through Linear's hosted MCP server; `read_only=True` switches to the read-only endpoint |
