...
| [Stripe](pydantic_ai_harness/stripe/) | Harness | Read one Stripe account through Stripe's hosted MCP server and approve each write; `read_only=True` drops writes |
